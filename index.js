...
const dc = {
  title: "About",
  description: "I'm a student at San Jose State University 🎓 studying masters in software engineering 💻. My 5 years of professional experience strengthened my passion for crafting impactful products for the clients to solving critical problems of the world 🌍. What kept me motivated was the excitement of adding value to mankind at scale, implementing enterprise solutions 🚀. Beyond coding, I enjoy software product management 📊. It inculcates the customer empathy which makes software solutions impactful to the highest degree 💡 ",
  experiences: [{
      url: "",
      date: "2022 - 2023",
      title: "Software Engineer, Deloitte Digital",
      role: "Software Engineer",
      description: "Digital Transformation Via Energy Management Systems & E-Commerce Solutions :  Led the development of software solutions for Energy, Resources & Industrial clients. These systems were instrumental in optimizing energy usage and enhancing operational efficiency, driving sustainability efforts and cost savings.I spearheaded the creation of cutting-edge ecommerce solutions tailored for retail clients. These solutions revolutionized the digital shopping experience, driving sales and revenue growth while providing seamless and engaging interactions for customers. This empowered me to take charge of impactful projects, leveraging my expertise in software engineering to deliver tangible results for clients across diverse industries",
      technologies: ["MERN Stack", "TypeScript","ContentStack", "Angular", "GitHub","Azure DevOps"]
  }, {
      url: "",
      date: "2019 - 2020",
      title: "Data Quality Engineer, Amazon Development Centre",
      role: "Data Quality Engineer",
      description: "Data Analysis For E-commerce Efficiency : Led data analysis using Python, R, SQL to enhance the order delivery experience, collaborating with cross-functional teams to implement actionable insights. Additionally, I optimized legacy query scripts, reducing processing times by 50% for Delivery Defect Metrics, and developed an R Scripts app automating KPI tracking, saving 780 man-hours and $3,600 annually. Leveraging Data Analysis proficiency, I influenced senior leadership with data-driven insights, while actively collaborating to devise innovative solutions, optimizing processes, and elevating the order delivery experience. I automated KPI tracking and visualization workflows, resulting in significant time and cost savings",
      technologies: ["Python", "R","SQL", "PLSQL", "AWS", "RedShift", "Tableau", "PowerBI", "Data Analysis & Analytics"]
  }, {
      url: "",
      date: "2016 - 2019",
      title: "Software Engineer, NetCracker Technology Pvt Ltd ",
      role: "",
      description: "Digital Transformation in Telecom, Media & Technology : Implemented web applications using HTML/CSS, Servlets, and RESTful APIs, while also developing custom rating and billing components using C++ and Perl, meticulously ensuring compliance with geographic tax regulations and client requirements. I developed over 50 custom solutions tailored to clients with user bases ranging from 9M to 70M, enhancing scalability and meeting diverse user needs. Additionally, I analyzed root causes and delivering code/data fixes for more than 200 issues, providing seamless systems migration and integration support for 11 major clients, ensuring a smooth and sustainable launch of their projects",
      technologies: ["HTML", "CSS", "Servlets", "RESTful APIs", "C++", "Perl","SQL","JavaScript","ReactJS"]
  }],
  skills: ["C++", "Python", "Java", "JavaScript", "TypeScript", "HTML", "CSS", "SQL", "MongoDB", "DynamoDB", "MySQL", "Oracle", "Express", "AngularJS", "ReactJS", "NodeJS", "REST API", "Django", "Amazon Web Services", "Docker", "GCP", "Kubernetes", "Apache Kafka", "Visual Studio", "JMeter", "JUnit","Salesforce Certified AI Associate"]
};
function Jd() {
  return v.jsxs("div", {
...
const ep = {
  ...
  writings: [{
    url: "https://github.com/RaviTejaGattu1/SmartCityTrafficCloud/",
    title: "Smart City Traffic Cloud Application ",
    subtitle: "Empowering cities with real-time traffic insights for safer, smarter mobility 📡🏙️🚦",
    date: "MongoDB, Express, Vue.js, Node.js, AWS EC2, S3, RDS, ECR, IAM, SSM, MySQL",
    readMinutes: "June, 2024",
    //coffe: "☕️"
  }, {
    url: "https://www.salesforce.com/trailblazer/ravitejagattu",
    title: "Salesforce Certified AI Associate",
    subtitle: "Strategies for stakeholder decisions based on Salesforce's Trusted AI Principles. 🧠🔍 Data management, security considerations, common business and productivity tools. 💼🛡️",
    date: "Salesforce Einstein | Salesforce Customer 360",
    readMinutes: "Dec, 2023",
    //coffe: "☕️"
  }, {
    url: "https://drive.google.com/file/d/1ryJYvBjjSwofJphvdctzzS8qWX352gJg/view",
    title: "IT Project Manager Certification by Indian School of Business",
    subtitle: "Software project management | Risk mitigation | Value Enhancement",
    date: "JIRA | CONFLUENCE | TRELLO | ASANA",
    readMinutes: "Feb, 2022",
    //coffe: "☕️ ☕️"
  }, {
    url: "https://github.com/RaviTejaGattu1/ClearCampaign_AppDataLayer",
    title: "ClearCampaign : An Application Data Layer Analysis",
    subtitle: "Creating transparency in the political arena by providing open access to comprehensive political ad campaign data",
    date: "Python | SQL | Google Cloud Platform | Google BigQuery",
    readMinutes: "May, 2024",
    //coffe: "☕️ ☕️"
  },]
};
function tp() {
  return v.jsxs("div", {
    ...
    children: [v.jsx("h2", {
      ...
      children: "Projects & Certifications"
    }), v.jsx("div", {
...
const Ju = {
  title: "Education",
  projects: [{
    name: "Master of Science, Computer Software Engineering",
    live: "https://sjsu.edu/msse/",
    github: "https://sjsu.edu/msse/",
    languages: ["SAN JOSE STATE UNIVERSITY","CGPA 4/4", "2024-2025 Dec"]
  }, {
    name: "Master of Business Administration, Software Product & Project Management",
    live: "https://www.iimv.ac.in/",
    github: "https://www.iimv.ac.in/",
    languages: ["INDIAN INSTITUTE OF MANAGEMENT","CGPA 3.9/4", "2020-2022"]
  }, {
    name: "BACHELOR OF ENGINEERING, ELECTRONICS & COMMUNICATION ENGINEERING",
    live: "https://www.uceou.edu/dept-electronics-communication.php",
    github: "https://www.uceou.edu/dept-electronics-communication.php",
    languages: ["OSMANIA UNIVERSITY","CGPA 3.64/4", "2012-2016"]
  }]
};
function ap() {
  return v.jsxs("div", {
  ...
  return v.jsxs("div", {
    ...
    children: [v.jsx(dp, {}), v.jsx("img", {
      ...
      children: [v.jsxs("h1", {
        ...
        children: "Purpose 🎯 | Passion ❤️‍🔥 | Compassion 🤝"
      })]
    })]
  })
}
